...
## RESULT:
Thus a website is designed to train the house price model and to predict the price and is hosted in the URL http://krishnamoorthy.student.saveetha.in:8000/HouseModelTraining/ and http://krishnamoorthy.student.saveetha.in:8000/HouseModelPrediction/ HTML code is validated.
